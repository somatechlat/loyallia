...
_MESSAGES_ES: dict[str, str] = {
    ...
    "AUTH_PASSWORD_MIN_LENGTH_8": "La contraseña debe tener al menos 8 caracteres.",
    "AUTH_BUSINESS_NAME_REQUIRED": "El nombre del negocio es obligatorio.",
    "AUTH_INVALID_ROLE": "Rol inválido. Permitidos: {allowed}",
    "AUTH_PASSWORD_MIN_LENGTH_6": "La contraseña debe tener al menos 6 caracteres.",
    "AUTH_PHONE_INVALID_FORMAT": "Formato inválido. Usa formato internacional: +593991234567",
    # Twilio Verify ()
...
_MESSAGES_EN: dict[str, str] = {
    ...
    "AUTH_PASSWORD_MIN_LENGTH_8": "Password must be at least 8 characters.",
    "AUTH_BUSINESS_NAME_REQUIRED": "Business name is required.",
    "AUTH_INVALID_ROLE": "Invalid role. Allowed: {allowed}",
    "AUTH_PASSWORD_MIN_LENGTH_6": "Password must be at least 6 characters.",
    "AUTH_PHONE_INVALID_FORMAT": "Invalid format. Use international format: +593991234567",
    # Twilio Verify ()
