...
_MESSAGES_ES: dict[str, str] = {
    ...
    # Redemption Rules
    "REDEMPTION_USAGE_LIMIT_PER_CUSTOMER_EXCEEDED": "Has alcanzado el límite de {limit} uso(s) por cliente ({used} usado(s)).",
    "REDEMPTION_USAGE_LIMIT_GLOBAL_EXCEEDED": "Este beneficio ha alcanzado su límite global de {limit} redenciones ({used} usada(s)).",
    ...
    "REDEMPTION_COOLDOWN_ACTIVE": "Debes esperar {cooldown_hours} hora(s) entre canjes. Tiempo restante: {remaining_minutes} minuto(s).",
