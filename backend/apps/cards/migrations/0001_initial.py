        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("cashback", "Tarjeta de Cashback"),
                            ("coupon", "Tarjeta de Cupón"),
                            ("affiliate", "Tarjeta de Afiliación"),
                            ...
                            ("referral_pass", "Programa de Referidos"),
                            ("multipass", "Multipase"),
                        ],
                        max_length=20,
                ...
                (
                    "icon_url",
                    models.URLField(
                        blank=True, default="", verbose_name="URL del ícono"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(default=True, verbose_name="Programa activo"),
                ),
                (
                    "metadata",
                    models.JSONField(
                        default=dict, verbose_name="Configuración específica"
                    ),
                ),
