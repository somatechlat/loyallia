...
E2E_TENANT_SLUG = "e2e-production-tenant"
E2E_USERS = {
    "owner": {
...
class Command(BaseCommand):
    help = "Create real RBAC E2E test users in the PRODUCTION database."

    def add_arguments(self, parser):
        parser.add_argument(
            "--password-file",
            default="../frontend/.auth/e2e-credentials.json",
            help="Path to write Playwright credential JSON file.",
        )
        parser.add_argument(
            "--generate",
            action="store_true",
            help="Generate a strong password and write it to the credential file.",
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Production E2E users provisioned. Credentials written to {password_file}.")
        )
    ...
    def _ensure_tenant(self) -> Tenant:
        tenant, _ = Tenant.objects.update_or_create(
            ...
            defaults={
                ...
                "address": "E2E Production Test Address",
