...
from apps.backup.services.config import get_backup_settings, get_minio_config
...
def cleanup_old_backups() -> dict:
    ...
    return {"success": True, "deleted_jobs": deleted_jobs, "deleted_s3_objects": deleted_s3_objects, "retention_days": retention_days, "cutoff": cutoff.isoformat()}
