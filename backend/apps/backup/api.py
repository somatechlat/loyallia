...
Endpoints:
    ...
    POST   /api/v1/superadmin/backups/restore/  -- Restore from local/offsite
    GET    /api/v1/superadmin/backups/restore/options/  -- Available restore options
    GET    /api/v1/superadmin/backups/restore/status/   -- Current restore job status
    GET    /api/v1/superadmin/backups/offsite/  -- List offsite backups on MinIO
...
# GET /api/v1/superadmin/backups/restore/options/
...
# GET /api/v1/superadmin/backups/restore/status/
...
# GET /api/v1/superadmin/backups/offsite/
