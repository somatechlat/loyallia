...
class Customer(TimestampedModel):
    ...
    referred_by = models.ForeignKey(
        ...
        help_text="Customer who referred this person.",
    )
...
class CustomerPass(models.Model):
    ...
    gift_balance = models.DecimalField(
        ...
        help_text="Current gift certificate balance.",
    )
    ...
    lifecycle_state = models.CharField(
        ...
        help_text="Current lifecycle state of the pass.",
    )
...
class ApplePassRegistration(models.Model):
    ...
    device_library_id = models.CharField(
        ...
        help_text="Apple device identifier.",
    )
    ...
    push_token = models.CharField(
        ...
        help_text="APNs push token for pass updates.",
    )
