    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actor_id",
                    models.UUIDField(db_index=True, verbose_name="ID del actor"),
                ),
                (
                    "actor_email",
                    models.CharField(max_length=255, verbose_name="Email del actor"),
                ),
                (
                    "actor_role",
                    models.CharField(max_length=20, verbose_name="Rol del actor"),
                ),
                (
                    "action",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="loyallia_au_actor_i_b75e5a_idx",
                    ),
                    models.Index(
                        fields=["resource_type", "created_at"],
                        name="loyallia_au_resourc_0e84be_idx",
                    ),
                    models.Index(
                        fields=["tenant_id", "created_at"],
                        name="loyallia_au_tenant__3d873d_idx",
                    ),
                    models.Index(
                        fields=["action", "created_at"],
                        name="loyallia_au_action_3eec23_idx",
                    ),
                ],
            },
        ),
