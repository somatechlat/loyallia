---
title: "Loyallia Production Deployment Guide"
document_id: "LOYALLIA-DOC-DEPLOYMENT_GUIDE.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-DEPLOYMENT_GUIDE.MD |
| **Title** | Loyallia Production Deployment Guide |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/04-runbooks/DEPLOYMENT_GUIDE.md` |
