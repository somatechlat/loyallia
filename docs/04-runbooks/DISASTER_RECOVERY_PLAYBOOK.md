---
title: "Loyallia — Disaster Recovery Playbook"
document_id: "LOYALLIA-DOC-DISASTER_RECOVERY_PLAYBOOK.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-DISASTER_RECOVERY_PLAYBOOK.MD |
| **Title** | Loyallia — Disaster Recovery Playbook |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/04-runbooks/DISASTER_RECOVERY_PLAYBOOK.md` |
