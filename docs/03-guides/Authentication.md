---
title: "Authentication Subsystem Guide"
document_id: "LOYALLIA-DOC-AUTHENTICATION.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-AUTHENTICATION.MD |
| **Title** | Authentication Subsystem Guide |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/03-guides/Authentication.md` |
