---
title: "Billing & Payments Subsystem Guide"
document_id: "LOYALLIA-DOC-BILLING-PAYMENTS.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-BILLING-PAYMENTS.MD |
| **Title** | Billing & Payments Subsystem Guide |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/03-guides/Billing-Payments.md` |
