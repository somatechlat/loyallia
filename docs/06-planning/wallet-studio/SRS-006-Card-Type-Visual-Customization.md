---
title: "SRS-006: Card-Type Visual Customization Matrix"
document_id: "LOYALLIA-DOC-SRS-006-CARD-TYPE-VISUAL-CUSTOMIZATION.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-006-CARD-TYPE-VISUAL-CUSTOMIZATION.MD |
| **Title** | SRS-006: Card-Type Visual Customization Matrix |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-006-Card-Type-Visual-Customization.md` |
