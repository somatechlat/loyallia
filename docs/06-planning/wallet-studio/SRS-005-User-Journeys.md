---
title: "SRS-005: User Journeys & Interaction Flows"
document_id: "LOYALLIA-DOC-SRS-005-USER-JOURNEYS.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-005-USER-JOURNEYS.MD |
| **Title** | SRS-005: User Journeys & Interaction Flows |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-005-User-Journeys.md` |
