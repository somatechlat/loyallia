---
title: "SRS-004: Appendices — Complete Platform Reference"
document_id: "LOYALLIA-DOC-SRS-004-APPENDICES.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-004-APPENDICES.MD |
| **Title** | SRS-004: Appendices — Complete Platform Reference |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-004-Appendices.md` |
