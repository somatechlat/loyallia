---
title: "SRS-008: Back of Pass (Reverse) Design Specification"
document_id: "LOYALLIA-DOC-SRS-008-BACK-OF-PASS-DESIGN.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-008-BACK-OF-PASS-DESIGN.MD |
| **Title** | SRS-008: Back of Pass (Reverse) Design Specification |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-008-BACK-OF-PASS-DESIGN.md` |
