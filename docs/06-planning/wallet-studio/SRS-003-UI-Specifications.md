---
title: "SRS-003: UI Specifications & Screen Mockups — OPTIMIZED v2"
document_id: "LOYALLIA-DOC-SRS-003-UI-SPECIFICATIONS.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-003-UI-SPECIFICATIONS.MD |
| **Title** | SRS-003: UI Specifications & Screen Mockups — OPTIMIZED v2 |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-003-UI-Specifications.md` |
