---
title: "SRS-009: User Custom Template Library"
document_id: "LOYALLIA-DOC-SRS-009-USER-TEMPLATE-LIBRARY.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS-009-USER-TEMPLATE-LIBRARY.MD |
| **Title** | SRS-009: User Custom Template Library |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/wallet-studio/SRS-009-USER-TEMPLATE-LIBRARY.md` |
