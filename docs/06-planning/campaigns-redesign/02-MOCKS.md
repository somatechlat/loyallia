---
title: "🎨 Documento 2: Mocks de Todas las Pantallas"
document_id: "LOYALLIA-DOC-02-MOCKS.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-02-MOCKS.MD |
| **Title** | 🎨 Documento 2: Mocks de Todas las Pantallas |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | Spanish |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/campaigns-redesign/02-MOCKS.md` |
...
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────────────┐   │
│  │ Campaña          │ Tipo   │ Audiencia       │ Estado  │ Enviados │ Fecha    │   │
│  ├─────────────────────────────────────────────────────────────────────────────┤   │
│  │ Promo de Verano  │ Wallet │ ☕ Café Rewards │ ✅ OK   │ 1,240    │ 12/06/26 │   │
│  │ Descuento VIP    │ Email  │ 🏆 VIP          │ ✅ OK   │ 89       │ 10/06/26 │   │
│  └─────────────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
