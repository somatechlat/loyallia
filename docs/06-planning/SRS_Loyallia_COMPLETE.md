...
document_id: "LOYALLIA-DOC-SRS_LOYALLIA_COMPLETE.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS_LOYALLIA_COMPLETE.MD |
| **Title** | SOFTWARE REQUIREMENTS SPECIFICATION (SRS) |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/SRS_Loyallia_COMPLETE.md` |
...
3. **Scanner App** — Progressive Web App (PWA) for in-store staff QR scanning  
...
Multi-tenant SaaS with strict per-tenant data isolation (`tenant_id` FK on all business data models). Three deployment tiers: API (Django), Dashboard (Next.js), Scanner App (PWA).
