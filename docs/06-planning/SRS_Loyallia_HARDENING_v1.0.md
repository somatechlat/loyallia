...
document_id: "LOYALLIA-DOC-SRS_LOYALLIA_HARDENING_V1.0.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-SRS_LOYALLIA_HARDENING_V1.0.MD |
| **Title** | SOFTWARE REQUIREMENTS SPECIFICATION (SRS) |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/06-planning/SRS_Loyallia_HARDENING_v1.0.md` |
