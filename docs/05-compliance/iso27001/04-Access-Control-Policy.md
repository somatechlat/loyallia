...
document_id: "LOYALLIA-DOC-04-ACCESS-CONTROL-POLICY.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-04-ACCESS-CONTROL-POLICY.MD |
| **Title** | Access Control Policy |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/05-compliance/iso27001/04-Access-Control-Policy.md` |
