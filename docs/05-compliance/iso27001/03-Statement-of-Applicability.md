---
title: "Loyallia — Statement of Applicability (SoA)"
document_id: "LOYALLIA-DOC-03-STATEMENT-OF-APPLICABILITY.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-03-STATEMENT-OF-APPLICABILITY.MD |
| **Title** | Loyallia — Statement of Applicability (SoA) |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/05-compliance/iso27001/03-Statement-of-Applicability.md` |
...
| **5.12** | **Management of information security incidents** | Yes | Incident response process required for LOPDP/GDPR breach notification (72h SLA). | Partial | Sentry alerts configured; Grafana alerting rules; `deploy/alerting/` alerting configuration; **Planned:** Formal incident response playbook and 72h notification automation |
