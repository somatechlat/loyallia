---
title: "Loyallia — Risk Assessment and Risk Treatment Plan"
document_id: "LOYALLIA-DOC-02-RISK-ASSESSMENT.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-02-RISK-ASSESSMENT.MD |
| **Title** | Loyallia — Risk Assessment and Risk Treatment Plan |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/05-compliance/iso27001/02-Risk-Assessment.md` |
