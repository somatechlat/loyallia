...
document_id: "LOYALLIA-DOC-05-INCIDENT-MANAGEMENT.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-05-INCIDENT-MANAGEMENT.MD |
| **Title** | Incident Management Procedure |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/05-compliance/iso27001/05-Incident-Management.md` |
