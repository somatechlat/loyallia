---
title: "Loyallia-K2 Review: Campaigns, Automation & Notifications"
document_id: "LOYALLIA-DOC-REVIEW_CAMPAIGNS_AUTOMATION.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-REVIEW_CAMPAIGNS_AUTOMATION.MD |
| **Title** | Loyallia-K2 Review: Campaigns, Automation & Notifications |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | Spanish |
| **Format** | Markdown (.md) |
| **Location** | `docs/07-reviews/REVIEW_CAMPAIGNS_AUTOMATION.md` |
