---
title: "Google OAuth + Google Wallet — Setup Paso a Paso"
document_id: "LOYALLIA-DOC-GOOGLE_SETUP_STEP_BY_STEP.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-GOOGLE_SETUP_STEP_BY_STEP.MD |
| **Title** | Google OAuth + Google Wallet — Setup Paso a Paso |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | Spanish |
| **Format** | Markdown (.md) |
| **Location** | `docs/08-references/GOOGLE_SETUP_STEP_BY_STEP.md` |
