---
title: "Wallet API Credentials Setup Guide"
document_id: "LOYALLIA-DOC-WALLET_CREDENTIALS_SETUP.MD"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-DOC-WALLET_CREDENTIALS_SETUP.MD |
| **Title** | Wallet API Credentials Setup Guide |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
| **Language** | English |
| **Format** | Markdown (.md) |
| **Location** | `docs/08-references/WALLET_CREDENTIALS_SETUP.md` |
