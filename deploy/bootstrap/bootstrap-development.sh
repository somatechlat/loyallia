...
# =============================================================================
# LOYALLIA — DEVELOPMENT BOOTSTRAP (ISOLATED, IDEMPOTENT)
# =============================================================================
# This script is for LOCAL DEVELOPMENT ONLY.
# It uses .bootstrap_secrets.development.env and development settings.
...
SECRETS_FILE="${BOOTSTRAP_SECRETS_FILE:-$PROJECT_ROOT/.bootstrap_secrets.development.env}"
RESCUE_DIR="$PROJECT_ROOT/.agents"
BOOTSTRAP_VOL="loyallia_bootstrap_tmp"
VAULT_KV_PATH="loyallia/development"

export COMPOSE_FILE="docker-compose.yml"
echo "[bootstrap] DEVELOPMENT BOOTSTRAP — using COMPOSE_FILE=$COMPOSE_FILE"
...
migrate_and_seed() {
    ...
    docker compose exec -T api python manage.py seed_subscription_plans \
        --settings loyallia.settings.development 2>/dev/null || {
