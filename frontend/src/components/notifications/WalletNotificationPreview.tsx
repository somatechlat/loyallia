    ...
    <div className={`grid gap-4 ${showApple && showGoogle ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
      ...
      {showApple && (
        <div className="space-y-2">
          ...
          {/* iPhone mockup */}
          <div className="relative mx-auto w-52 bg-surface-900 rounded-[2rem] p-2 shadow-xl border border-surface-800">
            {/* Dynamic Island */}
            <div className="mx-auto w-16 h-1.5 bg-black rounded-full mb-3" />
            ...
            <p className="text-[9px] text-surface-500 text-center mt-3 px-2 leading-relaxed">
      ...
      {showGoogle && (
        <div className="space-y-2">
          ...
          <div className="relative mx-auto w-56 bg-surface-100 dark:bg-surface-800 rounded-2xl p-3 shadow-xl border border-surface-200 dark:border-surface-700">
            {/* Pass card */}
            ...
            <div className="mt-2 bg-white dark:bg-surface-900 rounded-xl shadow-lg border border-surface-200 dark:border-surface-700 overflow-hidden">
            ...
            <p className="text-[9px] text-surface-500 text-center mt-2 px-2 leading-relaxed">
