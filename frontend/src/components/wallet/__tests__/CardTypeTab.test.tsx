...
describe('CardTypeTab', () => {
  ...
  it('renders StampTab for stamp card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="stamp" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders CashbackTab for cashback card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="cashback" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders CouponTab for coupon card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="coupon" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders VIPTab for vip_membership card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="vip_membership" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders GiftTab for gift_certificate card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="gift_certificate" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders AffiliateTab for affiliate card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="affiliate" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders DiscountTab for discount card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="discount" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders CorporateTab for corporate_discount card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="corporate_discount" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders ReferralTab for referral_pass card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="referral_pass" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders MultipassTab for multipass card type', () => {
    ...
    render(<I18nProvider><CardTypeTab cardType="multipass" config={config} onChange={onChange} /></I18nProvider>);
  ...
  it('renders fallback for unsupported card type', () => {
    render(<I18nProvider><CardTypeTab cardType={'unknown' as CardType} config={undefined as never} onChange={onChange} /></I18nProvider>);
