/**
 * Icon map for STUDIO_TOOLS. The only place studio tool icons live (D-U2).
 */
...
function CardTypeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const TOOL_ICONS: Record<StudioToolId, React.ComponentType<{ className?: string }>> = {
  images: ImageIcon,
