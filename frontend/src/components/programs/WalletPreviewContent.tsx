...
function WalletPreviewContent({ type }: { type: string }) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-[220px] bg-black rounded-[36px] border-[3px] border-gray-700 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col ring-1 ring-white/10">
        {/* Dynamic Island */}
