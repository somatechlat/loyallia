---
title: "Loyallia Project README"
document_id: "LOYALLIA-README-001"
version: "1.0"
status: "approved"
...
| Field | Details |
|-------|---------|
| **Document ID** | LOYALLIA-README-001 |
| **Title** | Loyallia Project README |
| **Version** | 1.0 |
| **Date** | 2026-09-16 |
| **Author** | Engineering Lead |
...
```bash
docker exec loyallia-api pytest --ds=loyallia.settings.test_integration
```
